...
import { Suspense, CSSProperties, FormEvent, useEffect, useMemo, useState } from "react";
...
function NewEnergyOpportunityContent() {
...
export default function NewEnergyOpportunityPage() {
  return (
    <Suspense fallback={<div style={{ padding: 24 }}>Cargando energía...</div>}>
      <NewEnergyOpportunityContent />
    </Suspense>
  );
}
